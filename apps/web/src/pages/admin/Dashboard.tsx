...
import { Users, ShieldCheck, AlertTriangle, UserCheck, ArrowLeft, DollarSign, MessageCircle, ShieldAlert, Store } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#F8F5F2] pb-32">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        >
          <Store size={32} className="text-[#6F4E37]" />
          <span className="font-black text-sm">Manage Marketplace</span>
        </Button>
      </div>
