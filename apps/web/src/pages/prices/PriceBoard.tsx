    ...
    <div className="p-6 space-y-6 animate-in fade-in pb-32">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-3xl font-black">Price Board</h2>
            <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Live Market Prices</p>
          </div>
        </div>
      ...
      <Card className="p-6">
        <div className="flex justify-between items-center mb-6">
          <h3 className="font-black text-lg">Current Prices (रू per kg)</h3>
      ...
      <Card className="p-6 bg-gradient-to-br from-[#3A7D44] to-[#6F4E37] text-white">
        <h3 className="font-black text-lg mb-4">Price Trends</h3>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <p className="text-xs font-bold opacity-80 mb-1">Highest Gain</p>
            <p className="text-xl font-black">Roasted Beans</p>
            <p className="text-sm opacity-90">+3.2% this week</p>
          </div>
          <div>
            <p className="text-xs font-bold opacity-80 mb-1">Most Stable</p>
            <p className="text-xl font-black">Coffee Cherries</p>
            <p className="text-sm opacity-90">No change</p>
          </div>
        </div>
      </Card>
      ...
      <div className="bg-blue-50 border border-blue-100 p-5 rounded-3xl">
        <p className="text-xs text-blue-800 leading-relaxed">
          <strong className="font-black">Note:</strong> Prices are updated daily from verified sources. 
          Actual prices may vary by location and quality. Always verify prices before transactions.
        </p>
      </div>
    </div>
  );
